...
import seasonlogic.playoffs.brackets.drawers.TwoPlayerPlayoffBracketDrawer;
import settings.SeasonSettings;

public class TwoPlayerPlayoffBracket implements PlayoffBracket {
  ...
  public TwoPlayerPlayoffBracket(Calendar calendar, List<PlayerProfile> playoffParticipants,
      SeasonSettings settings) {
    firstRoundSeries = new ArrayList<>();
    playoffBracketDrawer = TwoPlayerPlayoffBracketDrawer.builder()
